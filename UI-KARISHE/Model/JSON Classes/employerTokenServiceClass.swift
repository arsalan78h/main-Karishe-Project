...
// MARK: - EmployerTokenClass
struct EmployerTokenClass: Codable {
    let token: String
...
//    func toJSON() -> String? {
//        let props = ["read": self.read , "editPosts": editPosts , "deletePosts": deletePosts , "editOthersAEPrivateMessage": editOthersAEPrivateMessage , "visualChat": visualChat , "employer": employer ]
//        do {
